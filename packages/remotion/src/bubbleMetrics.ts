...
/** gap между сообщениями разных отправителей */
export const MESSAGE_ROW_GAP = 24;
/** gap между подряд идущими сообщениями ОДНОГО отправителя — без подписи имени */
export const MESSAGE_ROW_GAP_SAME_SENDER = 6;
